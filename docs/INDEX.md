...
| [state-archive/](state-archive/INDEX.md) | Frozen older STATE history, split out to keep STATE.md scannable (S36→P0 … S198 across nine files) — read its INDEX first |
...
| [state-archive/](state-archive/INDEX.md) | What did STATE.md say about a sprint that has since been archived? (S36→P0 … S198, frozen) |
