...
**Last updated:** 2026-09-18 10:12 AEST · **Version:** 0.98.08 · **🟩 Two decisions taken under delegation — [ADR-0029](decisions/0029-a-revise-is-a-finding-an-overturn-is-a-block.md) (`revise` records, `overturn` blocks) and [ADR-0025](decisions/0025-concentration-measures-the-book-position-risk-measures-the-capital-base.md) *Correction* (iso-risk sizing withdrawn on EXP-012); both await implementation and their named tests.**
