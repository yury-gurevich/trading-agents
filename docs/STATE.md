...
- **Exit authority: alpha proposes, risk disposes (feat, 0.76.00, 2026-07-24 — ADR-0017).** The
  ...
  (`29a36f4`), `DeployRecord …:s141:29a36f4` written. **Functionality check PENDING** tonight's
  22:30 UTC run. Durable stop stays broker-native (ADR-0015 §3, still open).
