...
**Last updated:** 2026-09-16 21:01 AEST · **Version:** 0.98.07 · **🟠 S210 BUILT locally on `sprint-210-concentration-divides-by-the-book` — concentration gates divide by deployed capital and below-floor books render `NOT_EVALUATED`; local `make ci` is green, remote/exact-SHA proof is pending.**
