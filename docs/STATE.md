...
**Last updated:** 2026-09-05 13:05 AEST · **Version:** 0.96.00 · **🚨 Two sprints merged and neither is running: the fleet is on `s196` and S198 moved the vocabulary, so the deploy is a full `up` before Monday.**
