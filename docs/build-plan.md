...
| **Qlib Phase Q2** Analyst Alpha158 pillar | **planned** (S68: 20 time-series features — ROC/STD/MAX/MIN/IMAX/IMIN at 4 horizons — computed per ticker, cross-sectional z-score → 0–100 fifth pillar; `alpha158_pillar_weight=0.00` off by default; pyqlib-free; operator enables after 20-day IC comparison) |
