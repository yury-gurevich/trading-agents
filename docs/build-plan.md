...
| P11 Decision-logic depth | **active** (extension; analyst scoring complete — S30–S33 technical (15 indicators), S35 fundamental, S38 relative strength, S39 signal-diversity; remaining: PM/scanner/reporter deterministic gaps; sentiment split out to P12) |
