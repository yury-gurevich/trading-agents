...
| P11 Decision-logic depth | **active** (extension; S30–S33 technical engine complete — 15 indicators; S34 provider fundamentals feed shipped; analyst fundamental scoring → news/sentiment + relative strength, PM/scanner/reporter gaps to follow) |
