...
| P11 Decision-logic depth | **active** (extension; S30 analyst technical core + S31 oscillators/volatility shipped — 9 indicators; volume/event+patterns, provider data feed → fundamental/sentiment, PM/scanner/reporter gaps to follow) |
