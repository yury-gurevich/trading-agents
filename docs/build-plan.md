...
| --- | --- |
| P0 Boundary map | **complete** |
| P1 Kernel runtime | **active** (S01/S07 both bus backends, S03 Neo4j GraphStore, S08 observability shipped; S22 MCP binding in progress; RAG remains; S02 superseded by ADR-0001) |
