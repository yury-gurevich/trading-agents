...
| P11 Decision-logic depth | **active** (extension; S30 technical core + S31 oscillators/volatility + S32 volume/event shipped — 12 indicators; patterns, provider data feed → fundamental/sentiment, PM/scanner/reporter gaps to follow) |
