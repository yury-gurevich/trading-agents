...
| P11 Decision-logic depth | **active** (extension; S30 technical core + S31 oscillators/volatility + S32 volume/event + S33 patterns/smoothing/calendar shipped — 15 indicators, deterministic technical engine complete; provider data feed → fundamental/sentiment + relative strength, PM/scanner/reporter gaps to follow) |
