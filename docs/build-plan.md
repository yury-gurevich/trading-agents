...
| P11 Decision-logic depth | **active** (extension; S30 technical core + S31 oscillators/volatility shipped — 9 indicators; S32 volume/event handed off → 12; patterns, provider data feed → fundamental/sentiment, PM/scanner/reporter gaps to follow) |
