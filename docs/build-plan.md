...
| P10 Curator | **active** (S27 dataset assembly + S28 advisory training trigger shipped — build_dataset/describe_corpus, versioned splits, train_predictor deterministic baseline + frozen evidence, never-influences-decision invariant proven; S29 predictor registry + promotion gate closes it) |
