...
| P11 Decision-logic depth | **active** (extension; S30 analyst technical core shipped, S31 oscillators+volatility handed off; volume/event+patterns, provider data feed → fundamental/sentiment, PM/scanner/reporter gaps to follow) |
