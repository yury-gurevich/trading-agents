...
| P11 Decision-logic depth | **active** (extension; S30 analyst technical scoring core — RSI/MACD/Bollinger/SMA/EMA — handed off; oscillators, patterns, fundamental/sentiment (needs provider data feed), PM/scanner/reporter gaps to follow) |
