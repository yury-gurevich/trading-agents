...
| P11 Decision-logic depth | **active** (extension; analyst scoring complete — S30–S33 technical (15 indicators), S35 fundamental, S38 relative strength, S39 signal-diversity; S40 PM reward/risk gate; S50 scanner beta-cap; S51 provider sector feed; S52 PM sector-concentration cap (PM risk-gate pair complete); remaining: scanner earnings-window, reporter profit-factor+expectancy; sentiment split out to P12) |
| P12 Sentiment (champion–challenger) | **active** (all 3 scorers live: S36 news feed, S37 lexicon champion, S46 SentimentReading node, S47/S48 provider challenger, S49 forecaster/FinBERT first runtime — advisory shadow, never gates; remaining: the scorecard harness comparing the 3 readings vs forward returns (needs a live news-accrual runway) + the full Loughran–McDonald master dictionary; ADR-0002) |
