...
| [0022](0022-the-veto-gates-buys-never-exits.md) | The veto gates buys, never exits | ✅ Accepted | Does the deliberation veto block execution, and what does it block? How do we tell “the veto has not run yet” from “the veto is not deployed”? | `execution` `deliberation` `risk` `adr` |
