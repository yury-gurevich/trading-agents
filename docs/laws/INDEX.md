...
| surfaces | ✅ LOCKED v1 (S229) | 27 / 34 | Component book under `surfaces/laws/`; dashboard, CLI, MCP, chat and operator-intent write boundaries; selected-run scoping cites corrected DRIFT-022 |
