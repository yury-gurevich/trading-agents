...
| [dependencies.md](dependencies.md) | Layer-0 dependency charter: `DEP-POSTGRES`, rollback-only `DEP-NEO4J`, `DEP-BUS`, `DEP-FEED`, `DEP-BROKER`; the "green bill of health" that must pass before any agent can be green | Amend when a new external dependency is added or retired |
