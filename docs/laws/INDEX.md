...
| --- | --- | --- | --- |
| provider | ✅ LOCKED v1.1 (S187) | 16 / 62 | S187 adds PARAM rows only; S156 citation check; counters are clauses proven / clauses declared — 22 law clauses still have no row (S157 warn-only backlog) |
| analyst | ✅ LOCKED v1.2 (S186), amended **v1.3** (S198) | 25 / 48 | S198 declares and proves `ANLZ-OBS-05` — a recorded realized drawdown declares its horizon; S156 citation check plus S186's `ANLZ-OBS-04`; counters are clauses proven / clauses declared — 12 law clauses still have no row (S157 warn-only backlog) |
...
| portfolio_manager | ✅ LOCKED v1 (S70), amended **v1.4** (S197) | 29 / 48 | S197 declares and proves `PM-OBS-03` — an evaluated concentration gate names what it examined; S184 made PM-NEV-07/08/09 green and closed the v1.3 widened PM-NEV-06 and PM-TYP-03 rows; 12 law clauses still have no row (S157 warn-only backlog) |
...
| execution | ✅ LOCKED **v1.4** (S190) | 35 / 61 | S190 adds/proves `EXEC-OBS-05`, adds the missing `EXEC-OBS-03` liveness-limb proof, and proves `EXEC-STA-05`; counters are clauses proven / clauses declared — 13 law clauses still have no row (S157 warn-only backlog) |
