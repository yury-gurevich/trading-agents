...
| --- | --- | --- | --- |
| provider | ✅ v1.2 (LOCKED) | 17 / 62 | 🟨 partial — **17 of 62 clauses proven**; S213 sharpens and proves `PROV-OUT-03` for FMP `^VIX` freshness without adding clauses; S187 added PARAM rows only; S204 gives every clause a row and promotes missing rows to a hard gate; S169-sweep demoted `PROV-OUT-04` |
