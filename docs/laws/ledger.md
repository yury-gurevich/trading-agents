...
| portfolio_manager | ✅ v1 (LOCKED) | 25 / 47 | 🟨 partial — **25 of 47 clauses proven**; the v1.3 amendment (ADR-0023) added PM-NEV-07/08/09, all ⬜ by design, and widened PM-NEV-06 and PM-TYP-03 with ⬜ rows naming the uncovered half |
