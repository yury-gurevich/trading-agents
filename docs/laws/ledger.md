...
| scanner | ✅ v1.2 (LOCKED) | 18 / 41 | 🟨 partial — **18 of 41 clauses proven**: S205 rewrites `SCAN-TYP-01` into required fields and closes DRIFT-047 without moving the count; S183 added and proved `SCAN-OUT-06`/`SCAN-OUT-07`; S204 gives every clause a row and promotes missing rows to a hard gate |
| analyst | ✅ v1.4 (LOCKED) | 25 / 48 | 🟨 partial — **25 of 48 clauses proven** after S205 rewrites `ANLZ-TYP-01` into required fields without moving the count; S198 adds and proves `ANLZ-OBS-05`; S186 adds and proves `ANLZ-OBS-04`; S204 gives every clause a row and promotes missing rows to a hard gate · S152 declared 3 new clauses (43→46) · S169-sweep demoted `ANLZ-OBS-01` |
| forecaster | ✅ v1.2 (LOCKED) | 17 / 45 | 🟨 partial — **17 of 45 clauses proven** after S205 rewrites and proves `FORE-TYP-01`; 28 have a gray row |
...
| deliberator | ✅ v1.6 (LOCKED) | 20 / 55 | 🟨 partial — **20 of 55 clauses proven** after S205 rewrites and proves `DLIB-TYP-01`; S200 adds `DLIB-OBS-07` and promotes `DLIB-IDM-02`; S199 adds `DLIB-OBS-05`/`DLIB-OBS-06`; S172 proves concurrent-order record order and pending-reply handling; S194 adds `DLIB-OBS-04`; S189 added stop-reason audit evidence; S167 proves queryable fail-open causes |
| execution | ✅ v1.5 (LOCKED) | 35 / 61 | 🟨 partial — **35 of 61 clauses proven** after S205 rewrites `EXEC-TYP-03` into required fields without moving the count and records DRIFT-060/DRIFT-061; S190 added/proved `EXEC-OBS-05`, the missing `EXEC-OBS-03` liveness limb, and `EXEC-STA-05`; S204 gives every clause a row and promotes missing rows to a hard gate |
...
| reporter | ✅ v1.1 (LOCKED) | 20 / 39 | 🟨 partial — **20 of 39 clauses proven** after S205 rewrites `RPT-TYP-01` into required fields without moving the count; S204 gives every clause a row and promotes missing rows to a hard gate |
| researcher | ✅ v1.1 (LOCKED) | 20 / 43 | 🟨 partial — **20 of 43 clauses proven** after S205 rewrites and proves `RES-TYP-01`; 23 have a gray row |
