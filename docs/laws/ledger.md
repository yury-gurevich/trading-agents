...
| analyst | ✅ v1.2 (LOCKED, amended **v1.3**) | 25 / 48 | 🟨 partial — **25 of 48 clauses proven** after S198 adds and proves `ANLZ-OBS-05` (a recorded realized drawdown declares the horizon it covers — the outcome half ADR-0013 assumed and never built); S186 adds and proves `ANLZ-OBS-04`; 10 have a gray row and 12 have no row at all (S157 warn-only backlog) · S152 declared 3 new clauses (43→46) · S169-sweep demoted `ANLZ-OBS-01` |
