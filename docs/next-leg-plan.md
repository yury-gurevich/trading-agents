...
| ID | Item | Size | Notes |
| --- | --- | --- | --- |
| E17.1 | ~~**Spike: can we buy a survivorship-free universe?**~~ 🟩 **MEASURED 2026-09-25 ([R008](research/survivorship-free-universe/INDEX.md), [DL-226](design-log.md)):** FMP historical constituents are **not** on our plan (402/403), nor Finnhub's (403); Wikipedia's *Historical components of the S&P 500* log reconciles to within ~3 names back to 2016; Alpaca SIP bars cover **95.3 %** of member-days (removed names **93.4 %**, not thin), ≈99 % with a six-name rename map. | S (1) | **Bar met: P17 proceeds survivorship-free**, not on the upper-bound fallback. E17.2 now also owes a rename map and a ticker-reuse guard (MON was reused). |
