...
| [sprint-134-assertion-hardening/](sprint-134-assertion-hardening/README.md) | S134 (backlog K) | `README.md`: assertion hardening reran the S132 `mutmut` scope; Round 2 reached 5,567/6,731 killed (82.71%), targeted analyst survivors dropped 249 -> 127, money-parser/gate-boundary kills recorded, HTTPS transport and string/render/audit exclusions justified |
