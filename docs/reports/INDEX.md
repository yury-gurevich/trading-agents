...
| [sprint-134-assertion-hardening/](sprint-134-assertion-hardening/README.md) | S134 (backlog K) | `README.md`: assertion hardening reran the S132 `mutmut` scope; 5,440/6,731 killed (80.82%), targeted money-parser/gate-boundary kills recorded, HTTPS transport and string/render/audit exclusions justified |
