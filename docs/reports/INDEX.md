...
| [sprint-133-servicebus-sas/](sprint-133-servicebus-sas/live-proof.md) | S133 (backlog I part 2) | `live-proof.md`: entity-level Service Bus SAS plan/provisioning, scoped Key Vault delivery, production secretRef flip, controlled Send/Listen least-authority and revocation proof |
| [sprint-134-assertion-hardening/](sprint-134-assertion-hardening/README.md) | S134 (backlog K) | `README.md` + `round-3-dispositions.csv`: assertion hardening reran the S132 `mutmut` scope; Round 3 reached 5,678/6,731 killed (84.36%), targeted analyst residuals dropped 127 -> 20 with 0 untriaged, money-parser/gate-boundary kills recorded, HTTPS transport and string/render/audit exclusions justified |
| [vocabulary-property-coverage/](vocabulary-property-coverage/README.md) | chore-vocabulary-property-completeness (0.84.03) | `README.md`: property dimension of the vocabulary guard proven a superset for the 2 enforced labels (Fill 34/45, Recommendation 21/22, zero undeclared, zero blind sites); 51 unenforced labels and 4 unresolvable-label sites reported as named limits |
