...
| --- | --- | --- | --- | --- | --- | --- |
| [R001](qlib-integration/) | Microsoft Qlib — integration vision + workflow addendum | 2026-06-19 | 🚧 In progress | Can this project benefit from qlib? Which agents, which components, which *workflows*, in what order? | Q1 (S58–S59) + Q2 (S68) + **Q1b (S110, shipped 0.53.00)** complete. Addendum 2026-07-04 sequencing: **Q1c rolling retrain (S111 packaged)** → **Q3 walk-forward harness (S112 packaged, after S111)** → Q5 governed factor mining; Q4 behind live-data prerequisite | `qlib` `forecaster` `analyst` `portfolio_manager` `researcher` `ml` `backtesting` |
