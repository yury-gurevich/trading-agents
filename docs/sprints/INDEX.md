...
| [sprint-158](sprint-158-fail-open-must-be-loud.md) | Make the deliberator's fail-open loud: a missing SAS-bundle topic raises instead of falling back, the manager preflights its peers before consuming work, fail-open becomes a queryable fact, and acceptance stops passing an inert veto | Ready — branch + worktree prepared; Key Vault bundle repair is operator work after merge |
