...
| [sprint-117](sprint-117-postgres-fleet-swap.md) | Postgres fleet swap (DL-43 step 2): Key Vault seed (tested-before-insert), composition flip to `POSTGRES_DSN`, alembic deploy step, DEP-POSTGRES probe, ADR-0001 superseded + ADR-0008 amended — the system of record becomes Postgres | **closed on branch** (0.60.00; not merged) |
