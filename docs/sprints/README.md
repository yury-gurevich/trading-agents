...
| [sprint-110](sprint-110-signal-evaluation-battery.md) | Forecaster signal evaluation battery (qlib Q1b): rank IC, per-date IC series (mean/std/IR), quantile spread + monotonicity, multi-horizon decay, rank-autocorrelation stability; OOS-only evaluation CLI | **packaged** |
