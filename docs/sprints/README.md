...
| [sprint-121](sprint-121-judge-promotion-challenger-recompile.md) | S119 resolution: promoted the compiled judge into `JUDGE_SYSTEM` (first ADR-0010 prompt promotion) + mandatory golden re-freeze; one bounded challenger recompile beat the promoted-judge champion and was adopted; defender untouched | **shipped on branch** (0.65.01; not merged) |
