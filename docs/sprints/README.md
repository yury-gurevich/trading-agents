...
| [sprint-103](sprint-103-dispatcher-cron.md) | Dispatcher cron: Container Apps Job (22:30 UTC) places a day-keyed `RunRequest` (calendar-gated, merge-deduped); fleet stays deployed behind KEDA cron scale-to-zero windows — the platform goes self-driving in paper mode | **planned** (handover Codex-ready) |
