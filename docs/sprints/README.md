...
| [sprint-68](sprint-68-analyst-alpha158-pillar.md) | Analyst Alpha158 pillar (qlib Phase Q2): 20 time-series features (ROC/STD/MAX/MIN/IMAX/IMIN at 4 horizons) → cross-sectional z-score → 0–100 fifth pillar; `alpha158_pillar_weight=0.00` (off by default); pyqlib-free (3.13 constraint) | **planned** |
