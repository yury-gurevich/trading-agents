...
| [sprint-48](sprint-48-analyst-provider-sentiment-reading.md) | Analyst persists the provider-sentiment shadow reading (`scorer="provider"` `SentimentReading`, aligned to lexicon, never gates) — completes the provider-sentiment challenger (P12) | **planned** |
