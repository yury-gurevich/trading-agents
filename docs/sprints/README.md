...
| [sprint-116](sprint-116-postgres-graphstore.md) | PostgresGraphStore (DL-43 step 1): psycopg adapter + alembic schema + backend parity suite + dual selector; live check on Neon free (Sydney) — the spine's Postgres landing | **packaged — ready for Codex** |
