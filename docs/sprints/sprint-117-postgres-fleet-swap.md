...
**Status:** MERGED — tag `v0.60.00` (cited by its README row) is on `main` (item 22 review, 2026-09-23); the line read: closed on branch — not merged/pushed (S116 merged `5f11b93`, 0.60.00)
**Effort:** S/M
