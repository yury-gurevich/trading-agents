...
**Status:** MERGED — merged to `main` in `09120b3c` (item 22 review, 2026-09-23); the line read: live check complete (2026-07-19) — code handback 2026-07-16, live proof after DRIFT-023 resolved
**Effort:** M
