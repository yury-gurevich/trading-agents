...
| [STATE-08.md](STATE-08.md) | S166–S171 + `chore-openai-cutover` | The **veto arc** at `0.89.07`–`0.90.01`: the race the veto had always lost (S166), the audit reporting *"Faults today = 0"* while 18 were written (S167), the second vendor after the Anthropic key hit its limit (S168), the uncorrelated peer client (S171), and DL-104's reading of the verdicts — **56 % self-agreement**, ~2 of 15 grounds surviving a check — which demoted the veto to advisory; the two S176 deploys (`0.90.10`/`0.90.11`) appended | 2026-08-17 |
| [STATE-09.md](STATE-09.md) | S172–S198 | The September proof run at `0.94.03`–`0.97.00`: the deliberator's debates finally running independently (S172, closing queue item **3**, the longest-open row at the time), the veto's self-agreement becoming a printed number with its denominator (S173 Part A), three gates that had never once fired measured and made honest (S195 beta cap, S196 earnings filter, S197 rendering), a deploy record that can no longer name an unbuilt commit (S180), an acceptance verdict that no longer flips on a quiet night (S191), and the S198 stop flip with the book set up to record whether it was right. Includes the CodeQL repair the S172 merge triggered on the enforcing gate | 2026-09-15 |
| [STATE-10.md](STATE-10.md) | S199–S201 + the item-6b posture decision | Three probes and renderers at `0.97.03`–`0.97.05`, 2026-09-13: token counts that come from the vendor instead of a word count (S199), a prompt that says which code rendered it (S200), a teardown verifier no longer blind where its deleter was (S201), the `s200` end-to-end deploy, and the same-day correction of work-queue item 50's premise. Plus the **2026-08-30 item-6b posture decision**, superseded — item 6b now un-gates on S206's post-deploy measurement, not on that argument | 2026-09-15 |
| [STATE-11.md](STATE-11.md) | S202–S203 + the item-47 promotion | The probes that could not fail, at `0.98.00`–`0.98.02`, 2026-09-13/14: the deliberator's credential probe learning to fail and the `proceeded_unvetoed` acceptance rule (S202), the five remaining inert probes and the `remediation_mode` guard with DL-166's measured 400-for-a-valid-key finding (S203), and the operator promotion of `EXECUTION_ORDER_PRICE_TOLERANCE_MODE` to `scaled` with the `s202a` deploy (work-queue item 47) | 2026-09-16 |
| [STATE-12.md](STATE-12.md) | S182–S184, the item-6b flip conditions + S206 | The late-August deliberation and sizing residue, 2026-08-21→31: ADR-0023's PM half proven live, the posture flip conditions, S182's unproven live check, and the NFLX harness residue. 🪤 The **73 % veto figure** recorded here is **superseded** — DL-173 traced it to `revise` and `overturn` collapsing into one action, and ADR-0029 narrowed the block to `overturn` only. **Appended 2026-09-20:** S206's rendered-verdict repair, its handback verification (branch *tip* proven, the S186 hazard checked) and the `s206` image-only deploy | 2026-09-20 |
| [STATE-13.md](STATE-13.md) | S208–S216 | The mid-September verdict, regime and fleet-check arc, 2026-09-17→19: S208's risk-gate wording, S209's stop-that-fired repair, S211/S212/S214 (reward-risk, the zero-submission trace, revise vs overturn), S213's regime VIX input, S215's build evidence, S216's LF sweep, and the `s208`/`s209`/`s214`/`s215` deploys | 2026-09-24 |
| [STATE-14.md](STATE-14.md) | S217–S223 + S207 + item 74 | The fleet-check, envelope and correlation-ramp arc, 2026-09-19→22: the master's fleet preflight (S217) and the run hold it feeds (S218), the Telegram notice (S219), the correlation ramp (S220), the gate learning rules the repo states (S221), one LLM adapter in the kernel (S222), evidence envelopes (S207, S223), the accepted-advisory re-check (item 74), the `s219`/`b18014e`/`7039bfb` deploys and `sched-2026-09-21`'s three live proofs | 2026-09-25 |
