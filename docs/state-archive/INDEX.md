...
| [STATE-12.md](STATE-12.md) | S182–S184 + the item-6b flip conditions | The late-August deliberation and sizing residue, 2026-08-21→31: ADR-0023's PM half proven live, the posture flip conditions, S182's unproven live check, and the NFLX harness residue. 🪤 The **73 % veto figure** recorded here is **superseded** — DL-173 traced it to `revise` and `overturn` collapsing into one action, and ADR-0029 narrowed the block to `overturn` only | 2026-09-18 |
