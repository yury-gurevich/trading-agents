...
the spec is written and handed over. Item 18 is the only item where being wrong **costs money**, and
as of 2026-08-20 both of its gates are cleared — [ADR-0023](decisions/0023-concentration-is-issuer-and-correlation-not-a-vendor-label.md)
is written and PM `laws.md` is amended to v1.3 — so it is now spec-ready, same as S172. Defensible
either way; say so if they swap.
