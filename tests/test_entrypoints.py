...
Note: the provider entrypoint runs a real ingest loop and the scanner runs a
graph-pull work loop (not idle_loop); both are tested separately under their
...
_AGENTS = [
    ("agents.analyst.entrypoint", "analyst"),
